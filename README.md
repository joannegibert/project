...
This project implements a SEIRD (Susceptible-Exposed-Infected-Recovered-Deceased) epidemiological model to simulate HPAI dynamics. The core numerical simulation is developed in C for computational efficiency, solving the system of differential equations for multiple scenarios.
